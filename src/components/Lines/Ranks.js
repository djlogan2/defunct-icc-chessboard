...
import {RANKS_ARRAY, RANKS_DISABLED, RANKS_LEFT_SIDE, RANKS_RIGHT_SIDE} from "../../constants/boardConstants";
...
const Ranks = ({height, side, perspective}) => {
  ...
  return (
    <div style={{
      ...
      position: "absolute",
      display: "flex",
      flexDirection: WHITE_PLAYER_PERSPECTIVE === perspective ? "column-reverse" : "column",
